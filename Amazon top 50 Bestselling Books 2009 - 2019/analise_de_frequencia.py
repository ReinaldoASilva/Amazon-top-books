...
all_summaries = [book["Summary"] for year in summary for book in summary[year]]

# Pré-processamento dos resumos
tokenized_summaries = [summary.lower().split() for summary in all_summaries]
combined_summary = ' '.join([' '.join(tokens) for tokens in tokenized_summaries])
